...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		txtBuscar.addInputMethodListener(new InputMethodListener() {
		...
		btnbuscar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (txtBuscar.getText().equals("")) {		
					LlenarTablaHuespedes();
					LlenarTablaReservas();
				} else if (txtBuscar.getText().matches("\\d+")) { // verificar si el texto es un numero
					LlenarTablaReservasId();
					LlenarTablaHuespedesId();
				} else { //busqueda por apellido
					LlenarTablaReservasApellido();
		...
		btnEditar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane.showMessageDialog(null, "le picaste");
				...
				if (filaReservas >= 0) {
					...
					JOptionPane.showMessageDialog(null, "dentro de if huespedes");
					ActualizarHuesped();
					limpiarTabla();
					LlenarTablaHuespedes();
					LlenarTablaReservas();
	...
	private List<Reserva> BuscarReservasApellido() {
		return this.reservaController.buscarApellido(txtBuscar.getText());
	}
	...
	private void LlenarTablaReservasApellido(){
		//Llenar tabla
		List<Reserva> reserva = BuscarReservasApellido();
		try {
			for (Reserva reservas : reserva) {
				modelo.addRow(new Object[] { reservas.getId(), reservas.getfechaE(), reservas.getfechaS(), reservas.getvalor(), reservas.getformaPago() });
			}
